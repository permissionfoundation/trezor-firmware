...
from artifacts.emulators.emulator_wrapper import EmulatorWrapper
...
BINDIR = os.path.dirname(os.path.abspath(__file__)) + "/artifacts/emulators"
CORE_BUILD = BINDIR + "/../../../../build/unix/micropython"
